...
Here, we design an automatic generator, 
...
[valuable encryption potentiality](https://github.com/HaolingZHANG/DNASpiderWeb/blob/main/experiments/step_5_security.py).
