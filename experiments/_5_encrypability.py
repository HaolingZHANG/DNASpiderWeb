...
def reconstruction(random_seed, sequencing_length, repeats, threshold=10000):
    ...
    if not path.exists("./results/data/step_5_encrypability_reconstruction.npy"):
        reconstructions = []
        ...
        save(file="./results/data/step_5_encrypability_reconstruction.npy", arr=reconstructions)
...
def draw_total(bit_length):
    ...
    pyplot.savefig("./results/figures/Figure M6.pdf",
...
def draw_reason():
    ...
    pyplot.xlabel("graph reconstruction percentage", fontsize=14)
...
if __name__ == "__main__":
    ...
    # why do we need to pay attention to encrypability?
